...
public class FrontServlet extends HttpServlet {
    ...
    private void invokeMethod(Route route, String methodToInvoke, HttpServletRequest request, HttpServletResponse response, Map<String, Object> view)
        ...
        try {
            ...
            for (int i = 0; i < parameterTypes.length; i++) {
                if (Map.class.equals(parameterTypes[i])) {
                    args[i] = view;
                }
    ...
    private void processRoute(Route route, HttpServletRequest request, HttpServletResponse response) throws NotFoundException, ServletException, IOException {
        ...
        invokeMethod(route, "before", request, response, view);
        invokeMethod(route, route.getAction(), request, response, view);
        invokeMethod(route, "after", request, response, view);
